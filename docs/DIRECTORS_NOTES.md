...
- The next gameplay question is deliberately open. Select one bounded player-facing problem before creating the next feature branch; do not let the long-term fantasy choose several systems at once.
