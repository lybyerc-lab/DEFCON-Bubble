...
- The Game Director refined the bipedal direction after candidate one: remove facial features, elongate the main membrane, and construct horns/limbs from smaller bubbles. The silhouette and gait must now carry identity without cartoon eyes. The castle also moves farther left and toothpicks launch from its roof, visually making the castle the defense platform.
- The seven-character concept lineup is approved as one enemy family; do not collapse it back into one generic bubble with stat changes. Basic/Brute, Fast/Runner, and Heavy/Big Blub are the first production interpretations. Big Blub is deliberately huge, five-hit, and slow.
- Environment presentation now has its own reusable scene boundary. Grow the beach through composed environment pieces without letting scenery own enemy schedules, collision outcomes, castle health, or input.
